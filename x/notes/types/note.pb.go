...
// source: cosmossdkexample/notes/v1/note.proto
...
func (*Note) Descriptor() ([]byte, []int) {
	return fileDescriptor_0c14b698f0aedb50, []int{0}
}
...
func init() {
	proto.RegisterType((*Note)(nil), "cosmossdkexample.notes.v1.Note")
}

func init() {
	proto.RegisterFile("cosmossdkexample/notes/v1/note.proto", fileDescriptor_0c14b698f0aedb50)
}

var fileDescriptor_0c14b698f0aedb50 = []byte{
	...
	,
}
...
func (m *Note) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Text) > 0 {
		i -= len(m.Text)
		copy(dAtA[i:], m.Text)
		i = encodeVarintNote(dAtA, i, uint64(len(m.Text)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintNote(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
